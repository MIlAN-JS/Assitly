...
try {
  ...
  from: 'onboarding@resend.dev',  // use this free test address
   to: to,       // only your own email works in test mode
  subject: "Verify your email for Assistly!!",
html: `
    ...
    <div style="max-width:520px;margin:0 auto;background:#ffffff;border-radius:8px;border:1px solid #e0d9d0;overflow:hidden;">
      ...
      <div style="padding:2rem 2.5rem;">
        ...
        <div style="text-align:center;margin:0 0 1.75rem;">
          <a href="${verifyUrl}" style="display:inline-block;background:#1A3A2A;color:#fff;text-decoration:none;padding:0.75rem 2rem;border-radius:6px;font-size:15px;font-weight:500;">Verify my email</a>
        </div>
        <p style="font-size:13px;color:#888;margin:0 0 0.5rem;">Or copy and paste this link:</p>
        <p style="font-size:12px;color:#1A3A2A;word-break:break-all;padding:0.75rem;background:#F4EFE8;border-radius:6px;margin:0 0 1.75rem;">${verifyUrl}</p>
