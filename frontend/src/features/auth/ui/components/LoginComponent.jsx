      ...
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-base text-gray-500">
            Sign in to your Assistly account
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 sm:p-10" style={{ border: "1px solid #e0d9d0" }}>
          ...
          <div className="flex items-center gap-3 mb-7">
            ...
            <span className="text-sm text-gray-400 whitespace-nowrap">or sign in with email</span>
            <div className="flex-1 h-px" style={{ background: "#e0d9d0" }} />
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-sm font-semibold" style={{ color: "#1A3A2A" }}>
                  Password
                </label>
                <a
